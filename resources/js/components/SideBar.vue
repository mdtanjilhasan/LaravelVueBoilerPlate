		...
		<div class="app-sidebar colored">
		    <div class="sidebar-header">
		        <a class="header-brand" href="/dashboard">
		            <div class="logo-img">
		<!--              <img src="src/img/brand-white.svg" class="header-brand-img" alt="Taskola"> -->
		            </div>
		            <span class="text">Taskola</span>
		        </a>
		    ...
		    <div class="sidebar-content">
		        <div class="nav-container">
		            <nav id="main-menu-navigation" class="navigation-main">
		                ...
		                <div class="nav-item has-sub" v-permissions="{role:'read-roles',user:'read-users'}">
		                    <a href="javascript:void(0)"><i class="ik ik-users"></i><span>User Management</span></a>
		                    <div class="submenu-content">
		                        <a v-can:read-roles href="/roles" class="menu-item">Role</a>
		                    </div>
		                    <div class="submenu-content">
		                        <a v-can:read-users href="/users" class="menu-item">User</a>
		                    </div>
		                </div>
